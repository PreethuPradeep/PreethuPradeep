...
## 🔭 What I'm Working On
- Building **Listura**, a modular task management Web API with ASP.NET Core Identity, EF Core, and clean architecture  
- Refining the **Healthcare Management System** capstone project with improved UI/UX and bug fixes  
- Developing **LoanManagement.API**, exploring financial domain modeling  
...
**Open to Junior Backend Developer (.NET) roles** where I can:
- Build and maintain RESTful APIs and microservices  
- Work with SQL Server, relational database design, and query optimization  
- Collaborate with cross-functional teams on real-world production systems  
- Continue learning best practices in software architecture and clean code

---

## 🤝 Open to Collaborations
Beginner-friendly **.NET**, **Web API**, or **full-stack** projects  
where I can contribute backend logic, database design, and API development while learning from experienced developers.
...
![GitHub Streak](https://streak-stats.demolab.com/?user=PreethuPradeep&theme=nightowl&hide_border=true&v=1)
